...
class GulfViewController: UIViewController{
    
    @IBOutlet weak var gvImage1: UIImageView!
    @IBOutlet weak var gvImage2: UIImageView!
    @IBOutlet weak var gvImage3: UIImageView!
